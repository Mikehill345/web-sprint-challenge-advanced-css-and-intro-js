...
function getArtistByIndex(array, index) {
  let artistName = artists[index].name;
...
function addArtist(id, name, years, genre, nationality, bio){
  ...
  // console.log(addArtist(20, 'Mike', '1992-2020', 'Web Design', 'American', 'stuff about stuff and stuff with more stuff. Did stuff with other stuff and it made stuff happen'))
